...
# Gem version used was build 544 #
##################################
...
gem-mapper -I gemIndexedHg19 -i $input_f -q 'phred' -o $output_dir/$input_f -t $core && echo "OK" >&2;
#combine all the maps into one file
map_f=$input_f.map
cat $output_dir/$input_f.[0-9].map > $output_dir/$map_f
